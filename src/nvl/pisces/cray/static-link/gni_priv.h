...
extern char gni_nic_assert[1 - 2*!(__builtin_offsetof(struct gni_nic,dla_cq_hndl) == 136)];
...
extern char gni_cq_assert1[1 - 2*!(__builtin_offsetof(struct gni_cq,kern_cq_descr) == 120)];
extern char gni_cq_assert2[1 - 2*!(__builtin_offsetof(struct gni_cq,cache_revisit_shift) == 160)];
                                           ...
                                           uint64_t addr, uint64_t len)
{
        ...
        uint64_t mem_va_end = mem_va + GNI_MEMHNDL_GET_PAGESIZE((*mem_hndl)) * GNI_MEMHNDL_GET_NPAGES((*mem_hndl));
